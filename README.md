...
O principal elemento da análise é o INDE (Índice de Desenvolvimento Educacional), um índice multidimensional que integra diferentes dimensões do desenvolvimento do estudante:
...
- O desempenho educacional é multifatorial  
- O engajamento (IEG) se destaca como fator relevante  
- Indicadores como IEG e IPV apresentam maior impacto no desempenho  
- Existe relação positiva entre engajamento (IEG) e desempenho acadêmico (IDA)  
...
### Modelo de Regressão  
Utilizado para estimar o desempenho acadêmico dos estudantes.

- O modelo explica parte dos resultados  
...
O desempenho educacional vai além de fatores acadêmicos, sendo influenciado por diferentes dimensões do desenvolvimento do estudante.
